...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'E栖设计', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '东方美学 × 宠物共生空间设计', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://eqisheji.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '一栖设计,宠物友好设计,室内设计,宠物空间设计,宁波设计工作室,慈溪室内设计师,不赚差价设计,异宠家装', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备940611', // 备案号 闽ICP备XXXXXX
  ...
  GREETING_WORDS:
    ...
    '阳光洒进来的角落 也为它留一席之地，我们为生命设计温柔落脚的家',
